...
latexmk -pdf -interaction=nonstopmode -halt-on-error -file-line-error \
  -outdir="$build_dir" atari-transfer-learning.tex
qpdf --check "$build_dir/atari-transfer-learning.pdf"
pages=$(pdfinfo "$build_dir/atari-transfer-learning.pdf" | awk '/^Pages:/ {print $2}')
