...
inline constexpr std::string_view kBodyControllerId{"paired_light_probe_v2"};
...
inline constexpr double kBodyControllerShaftTargetRadS{3.0};
inline constexpr double kBodyControllerSpeedGain{0.05};
