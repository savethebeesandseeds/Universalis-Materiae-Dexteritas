...
constexpr std::string_view kId{"history_expected_sarsa_v1"};
...
struct LightLearner::Impl {
    ...
    Json diagnostics() const {
        ...
        return Json{{"learner_id", kId}, {"learning_enabled", true}, {"elapsed_s", static_cast<double>(steps) * kDt},
...
Json LightLearner::specification() {
    return Json{{"learner_id", kId}, {"schema_version", "droid-blocks.online-light-learner.v1"},
